...
function display_theme_update_widget() {
    ...
    ?>
    <div class="mediapilote-dashboard-widget">
        <a href="<?php echo admin_url('admin.php?page=mediapilote-update'); ?>" class="dashboard-widget-action">
            ...
            <div class="widget-content">
                ...
                <span class="widget-button">Mise à jour du thème →</span>
            </div>
        </a>
    </div>
    <?php
